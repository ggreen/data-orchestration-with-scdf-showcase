...
helm registry login tanzu-sql-postgres.packages.broadcom.com \
       ...
       --password=$BROADCOM_PASSWORD


#rm -rf /tmp/vmware-sql-postgres-operator
helm pull oci://tanzu-sql-postgres.packages.broadcom.com/vmware-sql-postgres-operator --version v4.3.1 --untar --untardir runtime/tmp
...
kubectl create secret docker-registry regsecret \
        ...
        --docker-password=$BROADCOM_PASSWORD --namespace=sql-system


kubectl create secret docker-registry regsecret \
        --docker-server=https://tanzu-sql-postgres.packages.broadcom.com/ \
        --docker-username=$BROADCOM_USERNAME \
        --docker-password=$BROADCOM_PASSWORD --namespace=tanzu-data


helm install tanzu-postgres-operator runtime/tmp/vmware-sql-postgres-operator/  --wait  --namespace=sql-system
...
#sleep 30
#kubectl apply -f deployment/cloud/k8/data-services/postgres/postgres-db.yml
#sleep 40
